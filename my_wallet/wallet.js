...
export const sendTransaction_SOL = async(sender_PrivateKey, Recipient_PublicKey, amount)=>{
    const sender_Private_KEY_Uint8 = Uint8Array.from(Buffer.from(sender_PrivateKey, 'hex'));
    const sendKeyPair = solana.Keypair.fromSecretKey(Uint8Array.from(sender_Private_KEY_Uint8));
